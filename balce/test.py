...
def main(print=gt.putout) :
	...
	cesTest = (
		...
		# https://www3.ncrn.cornell.edu/new-very-hard-problems-of-balancing-chemical_YjoxOToyNg.pdf
	...
	memo_dir = None #'/storage/emulated/0/.ChemicalEquationSolutions.dat'
